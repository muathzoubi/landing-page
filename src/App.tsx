    ...
    <>
      ...
      <div className="container">
        <div className="app">
          ...
          <p>Build, and deploy your app with simple steps</p>
          <div className="grid-view ">
            <div className="logo card">
              <img width="70" height="70" src="./vite.svg" alt="metamorphose" />
            ...
            <div className="logo card">
              <img
                width="70 "
                height="70"
                src="https://img.icons8.com/color/100/idea.png"
                alt="idea"
              />
            ...
            <div className="logo card">
              <img
                width="70"
                height="70"
                src="https://img.icons8.com/fluency/70/metamorphose.png"
                alt="metamorphose"
              />
            ...
            <div className="logo card">
              <img
                width="70"
                height="70"
                src="https://img.icons8.com/stitch/70/easy.png"
                alt="easy"
              />
